-- ⚡ Kloud Hub v4.1 | MM2 + Mobile Support
...
local function SetupCharAdded(Plr)
    ...
    Plr.CharacterRemoving:Connect(function() 
        RemovePlayerCham(Plr) RemovePlayerESP(Plr) RemoveRoleESP(Plr)
    end)
end
for _, p in ipairs(Players:GetPlayers()) do SetupCharAdded(p) end
Players.PlayerAdded:Connect(SetupCharAdded)
Players.PlayerRemoving:Connect(function(p) RemovePlayerCham(p) RemovePlayerESP(p) RemoveRoleESP(p) end)
